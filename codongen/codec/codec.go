...
codonEncodeByteSlice(1, w, v.OperatorAddress[:])
codonEncodeByteSlice(2, w, func() []byte {
w := make([]byte, 0, 64)
EncodePubKey(&w, v.ConsPubKey)// interface_encode
return w
}()) // end of v.ConsPubKey
codonEncodeBool(3, w, v.Jailed)
codonEncodeUint8(4, w, uint8(v.Status))
codonEncodeByteSlice(5, w, EncodeInt(v.Tokens))
codonEncodeByteSlice(6, w, EncodeDec(v.DelegatorShares))
codonEncodeByteSlice(7, w, func() []byte {
wBuf := make([]byte, 0, 64)
w := &wBuf
codonEncodeString(1, w, v.Description.Moniker)
...
codonEncodeVarint(8, w, int64(v.UnbondingHeight))
codonEncodeByteSlice(9, w, EncodeTime(v.UnbondingCompletionTime))
codonEncodeByteSlice(10, w, func() []byte {
wBuf := make([]byte, 0, 64)
w := &wBuf
codonEncodeByteSlice(1, w, func() []byte {
wBuf := make([]byte, 0, 64)
w := &wBuf
codonEncodeByteSlice(1, w, EncodeDec(v.Commission.CommissionRates.Rate))
codonEncodeByteSlice(2, w, EncodeDec(v.Commission.CommissionRates.MaxRate))
codonEncodeByteSlice(3, w, EncodeDec(v.Commission.CommissionRates.MaxChangeRate))
return wBuf
}()) // end of v.Commission.CommissionRates
codonEncodeByteSlice(2, w, EncodeTime(v.Commission.UpdateTime))
return wBuf
}()) // end of v.Commission
codonEncodeByteSlice(11, w, EncodeInt(v.MinSelfDelegation))
...
codonEncodeByteSlice(1, w, v.DelegatorAddress[:])
codonEncodeByteSlice(2, w, v.ValidatorAddress[:])
codonEncodeByteSlice(3, w, EncodeDec(v.Shares))
...
codonEncodeUvarint(1, w, uint64(v.PreviousPeriod))
codonEncodeByteSlice(2, w, EncodeDec(v.Stake))
codonEncodeUvarint(3, w, uint64(v.Height))
...
wBuf := make([]byte, 0, 64)
w := &wBuf
codonEncodeString(1, w, v.CumulativeRewardRatio[_0].Denom)
codonEncodeByteSlice(2, w, EncodeDec(v.CumulativeRewardRatio[_0].Amount))
return wBuf
}()) // end of v.CumulativeRewardRatio[_0]
}
codonEncodeUint16(2, w, v.ReferenceCount)
...
wBuf := make([]byte, 0, 64)
w := &wBuf
codonEncodeString(1, w, v.Rewards[_0].Denom)
codonEncodeByteSlice(2, w, EncodeDec(v.Rewards[_0].Amount))
return wBuf
}()) // end of v.Rewards[_0]
}
codonEncodeUvarint(2, w, uint64(v.Period))
...
codonEncodeByteSlice(1, w, v.Address[:])
codonEncodeVarint(2, w, int64(v.StartHeight))
codonEncodeVarint(3, w, int64(v.IndexOffset))
codonEncodeByteSlice(4, w, EncodeTime(v.JailedUntil))
codonEncodeBool(5, w, v.Tombstoned)
codonEncodeVarint(6, w, int64(v.MissedBlocksCounter))
...
codonEncodeUvarint(1, w, uint64(v.ValidatorPeriod))
codonEncodeByteSlice(2, w, EncodeDec(v.Fraction))
...
wBuf := make([]byte, 0, 64)
w := &wBuf
codonEncodeString(1, w, v[_0].Denom)
codonEncodeByteSlice(2, w, EncodeDec(v[_0].Amount))
return wBuf
}()) // end of v[_0]
}
